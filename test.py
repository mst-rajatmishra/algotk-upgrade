# N2ytAU4CEliRrVXbNmCK6wj9oeyyM5uC
...
class LoginScreen:
    def __init__(self, root):
        self.root = root
        self.root.title("BLAUSTOCK LOGIN")
  ...
  # Set background color to blue
        ...
        title_label = tk.Label(title_frame, text="BLAU", font=('Consolas', 22, 'bold'), fg="LIGHTBLUE", bg="#3498db")  # Set light blue color for "BLAU"
        title_label.pack(side=tk.LEFT, padx=0)

        text_space = tk.Label(title_frame, text="STOCK", font=('Consolas', 22, 'bold'), fg="white", bg="#3498db")  # Set text color to white
...
class StockWishlistApp:
    def __init__(self, root, api_key, api_secret, access_token):
        ...
        # Initialize KiteConnect instances for buying and selsling
    ...
    def create_logo_and_text(self):
        ...
        # Title label
        title_label = tk.Label(title_frame, text="BLAUSTOCK", font=('Consolas', 22, 'bold'), fg="white", bg="#3498db")
    ...
    def create_footer(self):
            footer_label = tk.Label(self.root, text="\u00a9 2024 Blaustock. All rights reserved.", font=('Consolas', 12, 'bold'), fg="black", pady=5)
    ...
    def create_remove_button(self):
        ...
        remove_button_frame.pack(side=tk.LEFT, padx=0, pady=0, anchor="e")
